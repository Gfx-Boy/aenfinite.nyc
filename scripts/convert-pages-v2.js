...
const DEFAULT_OG_IMAGE = 'https://aenfinite.nyc/wp-content/themes/aenfinite.nyc/images/thumbnail.jpg';
const SITE_URL = 'https://aenfinite.nyc';
...
function generateFallbackSchemas(route, meta, enhancements, pageUrl) {
  ...
  const webPage = {
    ...
    publisher: {
      ...
      logo: {
        '@type': 'ImageObject',
        url: `${SITE_URL}/wp-content/themes/aenfinite.nyc/images/thumbnail.jpg`,
      },
    },
  };
  ...
  if (schemaType === 'Organization') {
    const orgSchema = {
      ...
      name: 'Aenfinite',
      url: SITE_URL,
      logo: `${SITE_URL}/wp-content/themes/aenfinite.nyc/images/thumbnail.jpg`,
      description: meta.description,
      address: {
        '@type': 'PostalAddress',
        addressLocality: 'New York',
