...
export const metadata: Metadata = {
  metadataBase: new URL('https://aenfinite.nyc'),
  title: {
    default: 'Aenfinite® | Professional Digital Innovation Agency',
    template: '%s | Aenfinite®',
  },
  description: 'Aenfinite® is a professional digital innovation agency in New York specializing in custom web design, brand identity, UI/UX design, digital marketing, e-commerce development, and comprehensive digital transformation solutions.',
  icons: {
    icon: [
      { url: '/wp-content/themes/aenfinite.nyc/favicon/favicon-32x32.png', sizes: '32x32', type: 'image/png' },
      { url: '/wp-content/themes/aenfinite.nyc/favicon/favicon-16x16.png', sizes: '16x16', type: 'image/png' },
    ],
    apple: [
      { url: '/wp-content/themes/aenfinite.nyc/favicon/apple-touch-icon.png', sizes: '180x180' },
    ],
    shortcut: '/wp-content/themes/aenfinite.nyc/favicon/favicon.ico',
  },
  manifest: '/wp-content/themes/aenfinite.nyc/favicon/site.webmanifest',
  openGraph: {
    siteName: 'Aenfinite',
    images: [{
  ...
  return (
    <html lang="en-US">
      <head>
        ...
        <link
          rel="preload"
          href="/wp-content/themes/aenfinite.nyc/static/css/mainf1a7.css?v=20250731-2020"
          as="style"
        />
        <link
          href="/wp-content/themes/aenfinite.nyc/static/css/mainf1a7.css?v=20250731-2020"
        ...
        <link
          rel="preload"
          href="/wp-content/themes/aenfinite.nyc/stylef1a7.css?v=20250731-2020"
          as="style"
        />
        <link
          href="/wp-content/themes/aenfinite.nyc/stylef1a7.css?v=20250731-2020"
      ...
      <body>
        ...
        <Script
          src="/wp-content/themes/aenfinite.nyc/static/js/jquery.min.js"
          strategy="afterInteractive"
        />
        <Script
          src="/wp-content/themes/aenfinite.nyc/static/js/slick.min.js"
          strategy="afterInteractive"
        />
        <Script
          src="/wp-content/themes/aenfinite.nyc/static/js/gsap.min.js"
          strategy="afterInteractive"
        />
        ...
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=G-NYC0000001"
          strategy="lazyOnload"
        />
        ...
        {/* Page functionality */}
        <Script
          src="/wp-content/themes/aenfinite.nyc/static/js/demo5163.js?v=20241204-0018"
          strategy="afterInteractive"
        />
        <Script
          src="/wp-content/themes/aenfinite.nyc/static/js/aos.js"
          strategy="afterInteractive"
        />
        ...
        <Script id="wpcf7-config" strategy="lazyOnload">
          {`var wpcf7 = {"api":{"root":"https://aenfinite.nyc/wp-json/","namespace":"contact-form-7/v1"},"cached":1};`}
        </Script>
